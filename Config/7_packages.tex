...
% quando ja nao houver codigo de joao lourenço, é apagar estes:
...
\usepackage{hyperref}
\usepackage{url}
%\usepackage{listings}      % descomentar para ter lista de codigos
\usepackage{xcolor}
\usepackage{enumerate}
\usepackage{lipsum}
\usepackage{svg}
\usepackage{hhline}
%\usepackage[notransparent]{svg} % usar isto para imagens .svg
\usepackage{amsmath}            % usar isto para imagens .svg
...
% \usepackage{listings}    % Fontification of source code listings; % descomentar para ter lista de codigos bonita/diferente?
