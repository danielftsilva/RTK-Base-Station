...
%\ntaddfile{glossaries}[symbols]{symbols}     % lista de Symbols

%%------------------------------------------------------------
% Main text - document chapters
%   syntax: \ntaddfile{chapter}{filename}
\ntaddfile{chapter}{chapter1_Introduction}
\ntaddfile{chapter}{chapter2_SotA}
\ntaddfile{chapter}{chapter3_Specs_Requirements}
\ntaddfile{chapter}{chapter4_HardwareDesign}
\ntaddfile{chapter}{chapter5_Prototyping}
\ntaddfile{chapter}{chapter6_Testing}
\ntaddfile{chapter}{chapter7_SolutionsNextVersion}
\ntaddfile{chapter}{chapterFinal_Conclusion}
\ntaddfile{chapter}{ChapterSpecifications_Workflow}        %remover este capitulo apos aproveitar as Specifications!
