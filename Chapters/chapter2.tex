...
Finally, the current most relevant solutions (base stations) are addressed and compared, as these will provide helpful guidelines to the development of future beRTK\textsuperscript{\textregistered}.
...
beRTK\textsuperscript{\textregistered} can be used for:
Enhanced Landing
Surveying fields precisely
Accurate Mapping
Review Work Processes

HEIFU, beRTK\textsuperscript{\textregistered} and beXStream can be used for:
\begin{itemize}
...
This section aims to clarify the exposed concepts about the device representing the center of the project covered by this Dissertation: the RTK base station. For that, important parameters of some of the most relevant solutions currently available in the market are presented in Tables~\ref{tab:curr_sol_POSITIONING},~\ref{tab:curr_sol_CONNECTIONS},~\ref{tab:curr_sol_ELECTRICAL} and~\ref{tab:curr_sol_MECH}, which represent positioning, connectivity, electrical, and physical/mechanical characteristics, respectively.
