...
Currently there are \textbf{6} major satellite arrangements that complement world navigation and precise positioning:


GPS: GPS was the first GNSS system. GPS was launched
in the late 1970s by the United States Department
of Defense. It uses a constellation of 27 satellites,
and provides global coverage.
\begin{itemize}
    ...
    \item NavIC (old name: IRNSS; India): \textbf{Date/n. of satellites} 
