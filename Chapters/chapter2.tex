...
This section aims to clarify the explanations presented earlier about the device that represents the center of the project covered by this Dissertation: an RTK base station. For that, an approach on the current available solutions is presented in Tables~\ref{tab:curr_sol_POSITIONING},~\ref{tab:curr_sol_CONNECTIONS},~\ref{tab:curr_sol_ELECTRICAL} and~\ref{tab:curr_sol_MECH}, which represent 
..., respectively.
...
\begin{table}[h]
	...
	\includegraphics[width=1.0\textwidth]{Chapters/Figures/curr_solutions/CONNECTIONS_v2.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1.0\textwidth]{Chapters/Figures/architecture_original.pdf}
...
\subsection{Accuracy}\label{sec:II_gnssAug_rtk_accuracy}
H: 7 mm + 1 ppm
...
\subsection{PPM}\label{sec:II_gnssAug_rtk_ppm}
