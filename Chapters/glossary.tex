...
\newglossaryentry{hot-plugging}{
	name={hot-plugging},
	description={The addition of components while the receiving system is powered on and without the need for shut-down.}
}

\newglossaryentry{ringing}{
	name={ringing},
	description={Oscillation that follows the output response to a abrupt change in input.}
}
