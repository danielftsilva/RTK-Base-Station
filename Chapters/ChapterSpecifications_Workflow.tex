...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% ChapterSpecifications_Workflow.tex
%% NOVA thesis document file
%%
%% Chapter with a short latex tutorial and examples
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\typeout{NT FILE ChapterSpecifications_Workflow.tex}
...
\chapter{Workflow Planning}\label{cha:ChapterSpecifications_Workflow}
...
Addressed in this document are the first two phases, represented in Chapter~\ref{cha:chapter2_SotA} and Section~\ref{sec:III_requirements}, respectively. These parts make up the theoretical component of the project, which naturally opens the way for the practical component, guided by phases 3 to 6.
...
To conclude the electrical aspect of the project, a prototyping phase (phase 4) is expected. This phase will provide a foundation for the firmware design phase (phase 5), which in turn will be based on the implementation of the system's interconnections between units and modules, granting a stable operation of the device.

Finally, phase 6 will help solidify all the work developed in the previous phases through the evaluation of the device's performance with respect to the specificated requirements.

Table~\ref{tab:gantt} graphically represents the expected duration of each of the phases through a Gantt chart.
...
\begin{table}[h!]
	...
	\begin{tabular}{ll}
        ...
        \midrule
        \multirow{2}*{\textbf{1. State of the Art}} & Analysis of the current state of the art, selection of typologies, \\
                            						& technologies, etc. \\
		\midrule
