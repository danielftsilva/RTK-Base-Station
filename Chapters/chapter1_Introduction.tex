...
\typeout{NT FILE chapter1_Introduction.tex}
...
%(explained in more detail in Chapter~\ref{cha:chapter2_SotA})
...
Also on the list of changes, yet with lower priority, is a more robust battery system -- that allows charging and using the base at the same time (preferably via \gls{USB} Type-C). The power consumption of this sector is intended to be cut in approximately half.
