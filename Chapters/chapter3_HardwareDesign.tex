...
% $V_{CLP}$ that may occur -- in this case it should comfortably exceed 15V
% transcondutacia gw
...
The reverse transfer capacitance ($C_{RSS}$) -- also known as Miller capacitance -- in the CSD17308Q3 model is XpF, about Y times lower than this same "grandeza" in the Si7212DN model (observable in the graph of Figure~\ref{fig:Si7212DN_crss}). This capacitance refers to Z, and therefore it is important that its value "seja" as low as possible, in order to reduce W.% parei aqui!
